...
const vertex = /* glsl */ `
  ...
  void main() {
    ...
    mPos.x += sin(t * random.z + 6.28 * random.w) * (0.1 + 1.4 * random.x);
    mPos.y += sin(t * random.y + 6.28 * random.x) * (0.1 + 1.4 * random.w);
    mPos.z += sin(t * random.w + 6.28 * random.y) * (0.1 + 1.4 * random.z);
